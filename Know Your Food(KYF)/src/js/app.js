App = {
  ...
  bindEvents: function() {
    ...
    // $(document).on('click', '.display_form', App.retrData);
  },
...
function A(result)
{
 ...
 // window.location.replace("http://localhost:3000/customer%20(copy).html");
  ...
  document.getElementsByClassName("display_form")[0].appendChild(ul) ;
  console.log("i");
